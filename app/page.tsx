      ...
      <Section className="mx-auto bg-[url('/hero-bg.svg')] bg-cover bg-no-repeat bg-top">
        <Container className="relative min-h-[600px] xl:flex xl:items-center xl:min-h-[700px]">
          <div className="flex flex-col items-start justify-center mb-[60px]">
            ...
            <p className="mb-4 max-w-[220px] text-[15px] font-medium text-[#c7e0f6] md:max-w-[328px] md:mb-6 md:text-[16px] xl:max-w-[480px] xl:text-[20px]">
              A convenient service where every cat, puppy, or parrot undergoes a
              full veterinary checkup before meeting you.
            </p>
            <p className="mb-10 max-w-[200px] font-semibold text-[15px] text-[#fafafa] md:max-w-[240px] md:mb-8 md:text-[16px] xl:text-[20px] xl:max-w-[480px]">
